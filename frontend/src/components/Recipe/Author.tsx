  ...
  return (
    <div className="bg-secondary rounded-lg shadow-lg p-6">
      ...
      <div className="flex items-center">
        <div className="w-20 h-20 relative rounded-full overflow-hidden border-4 border-white">
          <Image
      ...
      <div className="mt-4">
        ...
        >
          ...
          {/* Replace SVG with FaUserPlus icon */}
          Follow Me
        </button>
      ...
      <div className="mt-4 text-gray-300">
        <p>{bio}</p>
        <p className="text-accent mt-2 cursor-pointer">See More</p>
